  ...
  useEffect(() => {
    if (assessment && open) {
      form.reset({
        ...
        is_central: assessment.is_central || false,
      });
    }
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-xl">
        <DialogHeader>
          <DialogTitle>Bewerk Toets/Examen</DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="py-2 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="edit-leverage">Weging</Label>
              <Controller
                name="leverage"
                control={control}
                render={({ field }) => (
            ...
            <div className="flex items-center space-x-2 md:col-span-2">
              ...
              />
              <Label htmlFor="edit-is-central" className="font-normal">
