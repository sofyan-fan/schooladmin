...
export const CourseCard = ({
  ...
  return (
    ...
    <Card className="group relative py-1 flex flex-col h-full overflow-hidden border transition-all duration-300 ease-in-out hover:shadow-xl hover:border-primary/20">
      ...
      {/* --- Card Header --- */}
      <CardHeader className="p-4" onClick={onView}>
      ...
      {/* --- Card Content --- */}
      <CardContent
        className="flex-grow flex flex-col p-4 pt-0"
        onClick={onView}
      >
        <CardDescription
